...
//				searchKeyword와 일치하는 article.title의 내용들을 forListArticles 배열에 추가 => 검색을 forListArticles 안에서 함.
...
//			}
//		}
// 		getArticleIndexById 함수에서의 return 값을 그대로 활용 => 어차피 돌아가는 for문이 같으므로		
